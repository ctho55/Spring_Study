...
//-> 단, form 의 input Tag의 name과 vo 의 변수명이(setter로 찾음) 동일한 경우만 자동 대입됨. 
...
public class HomeController {
	...
	public String home(Locale locale, Model model) {
		...
		//** Logger Message Test
		// 1. {} 할용 
		logger.info("Test 1 Logger Message : {}.","안녕하세요 Test Test");
		String name = "홍길동";
		int age = 100; 
		...
		// 3. 로깅레밸
		logger.warn("Test 4 로깅레밸 warn name="+name+"age="+age);
		logger.error("Test 4 로깅레밸 error name="+name+"age="+age);
		logger.debug("Test 4 로깅레밸 debug name="+name+"age="+age);
		logger.trace("Test 4 로깅레밸 trace name="+name+"age="+age);
